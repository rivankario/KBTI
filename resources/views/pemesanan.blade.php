            ...
            <div class="row">
                <div class="col-md-6 mb-3 mb-lg-0 col-lg-3 align:center">
                  ...
                  <div class="field-icon-wrap">
                    ...
                    <input name ="ci_date" type="text" value="{{$data->ci_date}}" id="checkin_date" class="form-control">
                  </div>
                </div>
                <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                  ...
                  <div class="field-icon-wrap">
                    <div class="icon"><span class="icon-calendar"></span></div>
                    <input name="co_date" type="text" value="{{$data->co_date}}"id="checkout_date" class="form-control">
                  </div>
                </div>  
    ...
    <section class="section">
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-7">
            <h2 class="heading" data-aos="fade-up">Kamar Yang Tersedia</h2>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="/form-pemesanan" class="room">
