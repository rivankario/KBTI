    ...
    <section class="section bg-light">
      ...
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-7">
            <h2 class="heading" data-aos="fade">Penawaran terbaik</h2>
            <p data-aos="fade">Sedayu Hotel menawarkan harga terbaik bulan ini.</p>
          </div>
        </div>
        ...
        <div class="site-block-half d-block d-lg-flex bg-white" data-aos="fade" data-aos-delay="100">
          ...
          <div class="text">
            <span class="d-block mb-4"><span class="display-4 text-primary">IDR 1.000.000</span> <span class="text-uppercase letter-spacing-2">/ per malam</span> </span>
        ...
        <div class="site-block-half d-block d-lg-flex bg-white" data-aos="fade" data-aos-delay="200">
          ...
          <div class="text order-1">
            <span class="d-block mb-4"><span class="display-4 text-primary">IDR 2.500.000</span> <span class="text-uppercase letter-spacing-2">/ per malam</span> </span>
            <h2 class="mb-4">Presidential Room</h2>
            <p>Dengan 2 kamar tidur berdekor Jawa tradisional memiliki ruang tamu, ruang makan dengan dekorasi yang elegan.</p>
            <p><a href="#" class="btn btn-primary text-white">Book Now</a></p>
          </div>
        </div>
